...
public class TestYandexSpellerJSON {
    ...
    public void spellerApiCallsWithDifferentMethods() {
        ...
        RestAssured
                ...
                .param(PARAM_TEXT, SimpleWord.BROTHER.wrongVer())
                .log().everything()
                .post(YANDEX_SPELLER_API_URI_TEXT)
                .prettyPeek();
        System.out.println(repeat("=", 100));
        ...
        RestAssured
                ...
                .param(PARAM_TEXT, SimpleWord.BROTHER.wrongVer())
                .log().everything()
                .head(YANDEX_SPELLER_API_URI_TEXT)
                .prettyPeek();
        System.out.println(repeat("=", 100));
        ...
        RestAssured
                ...
                .param(PARAM_TEXT, SimpleWord.BROTHER.wrongVer())
                .log().everything()
                .options(YANDEX_SPELLER_API_URI_TEXT)
                .prettyPeek();
        System.out.println(repeat("=", 100));
        ...
        RestAssured
                ...
                .param(PARAM_TEXT, SimpleWord.BROTHER.wrongVer())
                .log().everything()
                .put(YANDEX_SPELLER_API_URI_TEXT)
                .prettyPeek();
        System.out.println(repeat("=", 100));
        ...
        RestAssured
                ...
                .log()
                .everything()
                .patch(YANDEX_SPELLER_API_URI_TEXT)
                .prettyPeek();
        System.out.println(repeat("=", 100));
        ...
        RestAssured
                ...
                .log()
                .everything()
                .delete(YANDEX_SPELLER_API_URI_TEXT).prettyPeek()
                .then()
